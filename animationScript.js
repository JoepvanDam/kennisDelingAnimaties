...
function page4examples(num) {
    ...
    if (document.getElementById("page4focusExp").focus == true) { document.getElementById("page4focusExp").blur(); }
...
function page5control(num) {
    ...
    if (num == 0) { animatedElement.style.top = "0"; animatedElement.style.left = "0"; page5showCode(1, ''); }
    else if (num == 1) { animatedElement.style.top = "0"; animatedElement.style.left = "calc(50% - 50px)"; page5showCode(2, ''); }
    else if (num == 2) { animatedElement.style.top = "0"; animatedElement.style.left = "calc(100% - 100px)"; page5showCode(3, ''); }
    else if (num == 3) { animatedElement.style.top = "calc(50% - 50px)"; animatedElement.style.left = "0"; page5showCode(4, ''); }
    else if (num == 4) { animatedElement.style.top = "calc(50% - 50px)"; animatedElement.style.left = "calc(50% - 50px)"; page5showCode(5, ''); }
    else if (num == 5) { animatedElement.style.top = "calc(50% - 50px)"; animatedElement.style.left = "calc(100% - 100px)"; page5showCode(6, ''); }
    else if (num == 6) { animatedElement.style.top = "calc(100% - 100px)"; animatedElement.style.left = "0"; page5showCode(7, ''); }
    else if (num == 7) { animatedElement.style.top = "calc(100% - 100px)"; animatedElement.style.left = "calc(50% - 50px)"; page5showCode(8, ''); }
    else if (num == 8) { animatedElement.style.top = "calc(100% - 100px)"; animatedElement.style.left = "calc(100% - 100px)"; page5showCode(9, ''); }
}
...
function page5showCode(num, colorString) {
    ...
    const animatedElement = document.getElementById("page5exp1animatedElement");
    if (num == 0) {
        animatedElement.style.top = "calc(50% - 50px)";
        animatedElement.style.left = "calc(50% - 50px)";
...
function page6showText(num) {
    ...
    else if (num == 8) { document.getElementById("page6exp1textBlock9").style.display = "block"; }
    else if (num == 9) { document.getElementById("page6exp1textBlock12").style.display = "block"; }
...
function page6animateElement9() {
    ...
    const id = setInterval(() => {
        if (frame <= 1000) {
            leftPos += 5;
            topPos = 100 * Math.sin((leftPos / 200) * (Math.PI * 2));
            animatedElement.style.top = topPos + "px";
            animatedElement.style.left = leftPos + "px";
            frame++;
        }
        else { clearInterval(id); }
    }, 10);
...
function animateQuestionMarkDot() {
    ...
    let frame = 0, topPos = 0, leftPos = 0, upDown = 1, leftRight = 1;

    const id = setInterval(() => {
        if (frame < 2523) {
            if (topPos <= 0) { upDown = 1; } else if (topPos >= 94) { upDown = 0; }
            if (leftPos <= 0) { leftRight = 1; } else if (leftPos >= 97) { leftRight = 0; }
            if (upDown == 0) { topPos -= 1; } else if (upDown == 1) { topPos += 1; }
            if (leftRight == 0) { leftPos -= 0.25; } else if (leftRight == 1) { leftPos += 0.25; }
            ...
            dot.setAttribute('onclick', 'continueQuestionMarkDot()');
            clearInterval(id);
        }
    }, 10);
}

function resetQuestionMarkDot() { document.getElementById("questionMarkDot").style.top = "0"; document.getElementById("questionMarkDot").style.left = "0"; document.getElementById("questionMarkDot").style.backgroundColor = "gray"; }

function continueQuestionMarkDot() {
    var dot = document.getElementById("questionMarkDot");
    let frame = 0, topPos = 78, leftPos = 48.5, upDown = 1, leftRight = 1;
    ...
    const id = setInterval(() => {
        if (frame < 3682) {
            ...
            dot.style.left = leftPos + "%";
            dot.style.backgroundColor = "var(--text-color)";
            dot.setAttribute('onclick', 'animateQuestionMarkDot()');
            clearInterval(id);
        }
    }, 10);
}
